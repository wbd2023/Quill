...
func expectDiagnostic(t *testing.T, result contract.ExecutionResult, expected diagnosticMatch) {
	t.Helper()
...
func hasDiagnostic(result contract.ExecutionResult, expected diagnosticMatch) (found bool) {
...
func diagnosticMatches(diagnostic contract.Diagnostic, expected diagnosticMatch) (matches bool) {
