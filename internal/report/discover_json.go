...
func writeListJSON(writer io.Writer, command string, result ListResult) (err error) {
	...
	return writeResultEnvelope(writer, command, payload)
}

/* ---------------------------------------- Explain JSON ---------------------------------------- */

func writeExplainJSON(writer io.Writer, command string, result ExplainResult) (err error) {
	return writeResultEnvelope(writer, command, result)
}
