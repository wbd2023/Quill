...
func decodeTools(schemas map[string]schemaPinnedTool) (tools PinnedTools) {
	tools = make(PinnedTools, 0, len(schemas))
...
func encodeTools(tools PinnedTools) (schemas map[string]schemaPinnedTool) {
	if tools == nil {
		return nil
	}
