...
func decodeTargets(schemas map[string]schemaTarget) (targets TargetConfigs) {
	targets = make(TargetConfigs, 0, len(schemas))
...
func encodeTargets(targets TargetConfigs) (schemas map[string]schemaTarget) {
	if targets == nil {
		return nil
	}
