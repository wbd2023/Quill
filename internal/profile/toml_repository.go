...
func decodeRepository(schema schemaRepositoryConfig) (repository RepositoryConfig) {
...
func encodeRepository(repository RepositoryConfig) (schema schemaRepositoryConfig) {
