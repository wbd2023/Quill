// Package lint performs AST-based style checks on Go source files.
//
...
//   - 2.2 Service package type naming: exported types end with Service/Config.
...
// Check analyses the provided directories and returns a process-style exit code.
func Check(arguments []string) (exitCode int) {
