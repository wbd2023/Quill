...
func CheckNamedReturns(fileSet *token.FileSet, file *ast.File) (violations []report.Violation) {
...
func CheckTypeElision(fileSet *token.FileSet, file *ast.File) (violations []report.Violation) {
	ast.Inspect(file, func(node ast.Node) bool {
...
func CheckNakedReturns(fileSet *token.FileSet, file *ast.File) (violations []report.Violation) {
	ast.Inspect(file, func(node ast.Node) bool {
