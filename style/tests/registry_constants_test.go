...
const (
	...
	checkPathBashScriptStructure  = "checks/bash/script-structure.sh"
	checkPathRepositoryASCII      = "checks/repository/ascii.sh"
	checkPathRepositoryMarkdown   = "checks/repository/markdown.sh"
	checkPathRepositoryNaming     = "checks/repository/naming.sh"
	checkPathRepositoryHeaders    = "checks/repository/section-headers.sh"
	checkPathRepositorySpelling   = "checks/repository/spelling.sh"
