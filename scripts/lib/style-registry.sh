...
REGISTRY_RUNNER_SCRIPT="${RUNNER_KIND_SCRIPT:-script}"
REGISTRY_RUNNER_SCRIPT_SCOPE="${RUNNER_KIND_SCRIPT_SCOPE:-script_scope}"
REGISTRY_RUNNER_EXECUTOR="${RUNNER_KIND_EXECUTOR:-runner}"
REGISTRY_RUNNER_TARGET_GOLANGCI_APP="${RUNNER_TARGET_GOLANGCI_APP:-golangci_app}"
REGISTRY_RUNNER_TARGET_GOLANGCI_TOOLS="${RUNNER_TARGET_GOLANGCI_TOOLS:-golangci_tools}"
REGISTRY_RUNNER_TARGET_AST_APP="${RUNNER_TARGET_AST_APP:-ast_app}"
REGISTRY_RUNNER_TARGET_AST_TOOLS="${RUNNER_TARGET_AST_TOOLS:-ast_tools}"
REGISTRY_TIER_ONE="${TIER_ONE:-tier1}"
REGISTRY_TIER_TWO="${TIER_TWO:-tier2}"
REGISTRY_TIER_THREE="${TIER_THREE:-tier3}"
